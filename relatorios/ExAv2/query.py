...
db = Database("bolt://54.166.241.199:7687", "neo4j", "flashlights-triangles-soups")
...
for a in aux:
    print(f'Nome: {a["t.name"]}, Terceira letra: {a["substring(t.name, 3, 1)"]}')
print("\n2-b")
aux = query.getPopulationAverage()
for a in aux:
    print(f'Cidade: {a["c.name"]}, População: {a["c.population"]}')
print("\n2-c")
